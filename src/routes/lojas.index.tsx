...
export const Route = createFileRoute("/lojas/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Conheça as lojas online parceiras com ofertas e cupões no OfertaPerfeita." },
...
function StoresPage() {
  ...
  return (
    <div className="container-page py-8">
      ...
      <p className="mt-2 text-sm text-muted-foreground">Todas as lojas configuradas na plataforma.</p>
      <div className="mt-8">
        {stores.isPending ? (
          ...
          <EmptyState title="Sem lojas ativas" description="As lojas aparecem aqui assim que forem ativadas." />
        ) : (
