  ...
  return (
    <div className="container-page max-w-3xl py-12">
      ...
      <div className="mt-6 space-y-4 text-sm leading-relaxed text-muted-foreground">
        <p>Os preços e disponibilidades apresentados são indicativos e pertencem às lojas de origem, podendo alterar-se sem aviso. Confirme sempre na loja antes de comprar.</p><p>O OfertaPerfeita não vende produtos nem processa pagamentos.</p>
      </div>
    </div>
  );
}
